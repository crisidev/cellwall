...
pub struct SandboxConfig {
    ...
    pub(crate) setup_ops: Vec<SetupOp>,
    pub(crate) unshare_user: bool,
    pub(crate) unshare_pid: bool,
    pub(crate) unshare_net: bool,
    pub(crate) unshare_ipc: bool,
    pub(crate) unshare_uts: bool,
    pub(crate) unshare_cgroup: bool,
    pub(crate) sandbox_uid: Option<Uid>,
    pub(crate) sandbox_gid: Option<Gid>,
    pub(crate) hostname: Option<String>,
    pub(crate) chdir: Option<PathBuf>,
    pub(crate) new_session: bool,
    pub(crate) die_with_parent: bool,
    pub(crate) clearenv: bool,
    pub(crate) setenv: Vec<(String, String)>,
    pub(crate) unsetenv: Vec<String>,
    pub(crate) cap_add: Vec<String>,
    pub(crate) cap_drop: Vec<String>,
    pub(crate) seccomp_fd: Option<i32>,
}
